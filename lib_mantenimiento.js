...
const SatexMantenimiento = {
    render: function(id) {
        ...
        // Mantenemos el pegado estricto de 1mm (4px) solicitado
        ...
        container.innerHTML = `
            <div style="display: flex; width: 100%; position: relative; font-family: 'Segoe UI', sans-serif; margin-top: 4px;">
                ...
                <div style="position: absolute; left: 50%; top: 0px; height: 356px; width: 2px; background-color: #f9b218; transform: translateX(-50%); z-index: 5;"></div>
