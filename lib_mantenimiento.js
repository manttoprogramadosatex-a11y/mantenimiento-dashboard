    ...
    render: function(id) {
        ...
        <div style="display: flex; width: 100%; height: 100%; position: relative; font-family: 'Segoe UI', sans-serif;">
            ...
            <div style="flex: 1; display: flex; flex-direction: column; padding: 5px 15px;">
                <div style="color: #ffffff; font-size: 18px; font-weight: bold; border-bottom: 2px solid #f9b218; padding-bottom: 2px; width: 100%; text-align: center; text-transform: uppercase; margin-bottom: 4px;">Mantto. Correctivo</div>
                
                <div style="display: flex; width: 100%; height: 160px; gap: 10px; margin-bottom: 10px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 4px; width: 80%; margin: 0 auto;">
            ...
            <div style="flex: 1; display: flex; flex-direction: column; padding: 5px 15px;">
                <div style="color: #ffffff; font-size: 18px; font-weight: bold; border-bottom: 2px solid #f9b218; padding-bottom: 2px; width: 100%; text-align: center; text-transform: uppercase; margin-bottom: 4px;">Mantto. Preventivo</div>
