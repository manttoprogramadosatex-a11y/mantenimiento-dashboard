...
const SatexMantenimiento = {
    render: function(id) {
        ...
        // Forzamos que el contenedor tenga espacio para mostrar la línea
        container.style.marginTop = "0px";
        container.style.paddingTop = "0px";
        container.style.minHeight = "100px"; // Blindaje para que no se pierda la línea

        container.innerHTML = `
            <div style="display: flex; width: 100%; height: 100%; position: relative; font-family: 'Segoe UI', sans-serif; margin-top: 4px;">
                
                <div style="position: absolute; left: 50%; top: 0px; height: 80px; width: 2px; background-color: #f9b218; transform: translateX(-50%); z-index: 5;"></div>
