const SatexMantenimiento = {
    render: function(id) {
        ...
        <div style="display: flex; width: 100%; height: 100%; position: relative; font-family: 'Segoe UI', sans-serif;">
            ...
            <div style="flex: 1; display: flex; flex-direction: column; padding: 2px 10px; position: relative; gap: 10px;">
                ...
                <div style="display: flex; width: 100%; height: 180px; gap: 5px;">
                    <div style="display: flex; width: 55%; justify-content: flex-start; gap: 2px;">
                        <div id="pmc-diario-container" style="width: 49%;"></div>
                        <div id="pmc-mensual-container" style="width: 49%;"></div>
                    </div>
                    <div style="width: 45%; display: flex; flex-direction: column; gap: 6px; justify-content: center;">
                        <div id="kpis-correctivo-container"></div>
                ...
                <div style="position: absolute; bottom: 85px; width: 100%; display: flex; justify-content: space-between; left: 0; padding: 0 10px; box-sizing: border-box;">
                    <div style="color: #f9b218; font-size: 11px; font-weight: bold; border-bottom: 1px solid #f9b218; width: 48%; text-align: center; text-transform: uppercase;">Dets. Personal Mantto.</div>
                    <div style="color: #f9b218; font-size: 11px; font-weight: bold; border-bottom: 1px solid #f9b218; width: 48%; text-align: center; text-transform: uppercase;">Pendientes Compras</div>
                </div>
