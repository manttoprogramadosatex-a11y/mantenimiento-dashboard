...
/* VERSION 2.5
   ...
   - Se agrega carga dinámica del % desde celda D4
   - No se elimina nada
...
const SatexPreventivoDesign = {
    render: function(id, cumplimiento) {
        ...
        // NUEVO: cargar cumplimiento real desde Google Sheet
...
/* ============================================================
   NUEVO: CUMPLIMIENTO DESDE D4
   ============================================================ */

async function obtenerCumplimientoDesdeSheet() {
    const sheetId = "16gfm9ZgivtCcpuRKpZQVuxfMcT2_fjpll5w8insJ3jg";
    const url = `https://docs.google.com/spreadsheets/d/${sheetId}/gviz/tq?gid=0&range=D4&tqx=out:json`;
...
async function cargarCumplimientoDesdeSheet() {
    try {
        const valor = await obtenerCumplimientoDesdeSheet();
