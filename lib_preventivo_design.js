...
/* VERSION 2.5
   - Se agrega carga dinámica del % desde Google Sheets (D4)
   - Se cambia fuente del número central
   - NO se elimina nada
...
const SatexPreventivoDesign = {
    render: function(id, cumplimiento) {
        ...
        /* ===== IMPORT FUENTE (NO AFECTA NADA EXISTENTE) ===== */
        ...
        <div style="display: flex; height: 100%; align-items: center; padding: 5px; gap: 15px; font-family: 'Segoe UI', sans-serif;">
            <div style="width: 35%; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                ...
                <div style="color: #a1b1c1; font-size: 9px; font-weight: bold; margin-top: 5px; text-align: center;">
        ...
        /* NUEVO: Cargar porcentaje dinámico */
...
async function cargarCumplimientoDesdeSheet() {
    try {
        ...
        const valor = parseFloat(json.table.rows[0]?.c[0]?.v) || 0;
