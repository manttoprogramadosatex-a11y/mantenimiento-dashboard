const SatexCardasDesign = {
    crearEstructura: function(numero, ac, max) {
        ...
        return `
        <div style="min-width: 123px; max-width: 123px; background: white; border-radius: 8px; padding: 10px; margin: 0px 5px; box-shadow: 0 4px 8px rgba(0,0,0,0.3); flex-shrink: 0; display: flex; flex-direction: column; align-items: center; border: 1px solid #ddd; font-family: 'Segoe UI', sans-serif;">
            ...
            <div style="width: 100%; height: 75px; position: relative; display: flex; justify-content: center; align-items: flex-end;">
                ...
                <div id="needle-${numero}" style="position: absolute; bottom: 8px; left: 50%; width: 3px; height: 48px; background: #222; transform-origin: bottom center; transform: translateX(-50%) rotate(${rotacionFinal}deg); border-radius: 3px; z-index: 10;"></div>
