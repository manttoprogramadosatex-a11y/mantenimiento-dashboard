const SatexHeaderDesign = {
    render: function(id) {
        ...
        <div style="background:#274a66; display:flex; align-items:center; height:60px; padding:0 15px; border-bottom:2px solid #1e3a50;">
            ...
            <h1 style="font-family:'Calibri'; font-size:26px; font-weight:bold; color:white; flex-grow:1; text-align:center; margin:0; text-transform:uppercase;">TABLERO MASTER MANTTO. SATEX TEXTIL</h1>
