const SatexCardasEngine = {
    dibujar: function(idContenedor) {
        ...
        if (!grid) return;
        const datos = [
            {id: 1, t: "CARDA 1", ac: 956, max: 1000}, {id: 2, t: "CARDA 2", ac: 707, max: 1000},
            {id: 3, t: "CARDA 3", ac: 0, max: 1000}, {id: 4, t: "CARDA 4", ac: 389, max: 1000},
            {id: 5, t: "CARDA 5", ac: 1088, max: 1000}, {id: 6, t: "CARDA 6", ac: 1031, max: 1000},
            {id: 7, t: "CARDA 7", ac: 651, max: 1000}, {id: 8, t: "CARDA 8", ac: 961, max: 1000}
        ];
    ...
    pintarGauje: function(canvas, ac, max) {
        ...
        ctx.lineWidth = 12; ctx.strokeStyle = '#eeeeee'; ctx.stroke();
