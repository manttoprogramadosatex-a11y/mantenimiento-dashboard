    ...
    render: function(id, datos) {
        ...
        const tabla = datos.map(m => {
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1.5fr 1.2fr; color: white; font-size: 12px; border-bottom: 1px solid rgba(255,255,255,0.05); padding: 5px 0; align-items: center;">
                ...
                <span style="color: #f9b218; text-align: right; font-weight: bold; padding-right: 3px;">${dias}d</span>
            </div>`;
        }).join('');

        container.innerHTML = `
        <div style="width: 100%; height: 100%; display: flex; flex-direction: column; overflow: hidden;">
            <div style="color: #ff9999; font-size: 11px; font-weight: bold; margin-bottom: 4px; text-transform: uppercase; display: grid; grid-template-columns: 1fr 1fr 1.5fr 1.2fr; border-bottom: 1px solid #ff9999; padding-bottom: 2px;">
                <span>TIPO</span>
