...
const SatexMaquinasInactivas = {
    ...
    render: function(id, datos) {
        ...
        const tabla = datos.map(m => {
            ...
            return `
            <div style="display: grid; grid-template-columns: 1fr 1fr 1.5fr 1fr; color: white; font-size: 13px; border-bottom: 1px solid rgba(255,255,255,0.05); padding: 5px 0; align-items: center;">
        ...
        <div style="width: 100%; height: 100%; display: flex; flex-direction: column; overflow: hidden;">
            <div style="color: #ff9999; font-size: 11px; font-weight: bold; margin-bottom: 4px; text-transform: uppercase; display: grid; grid-template-columns: 1fr 1fr 1.5fr 1fr; border-bottom: 1px solid #ff9999; padding-bottom: 2px;">
                <span>TIPO</span>
                <span style="text-align: center;">NÚM</span>
                <span style="text-align: center;">DESDE</span>
                <span style="text-align: right; padding-right: 5px;">DÍAS</span>
            </div>
            <div style="flex-grow: 1; overflow-y: auto; overflow-x: hidden; padding-right: 2px;">
                ${tabla}
            </div>
        </div>`;
    }
